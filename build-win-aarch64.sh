...
cp native/build-aarch64/src/Release/Exiles.exe build/win-aarch64/
cp build/libs/Exiles.jar build/win-aarch64/
...
echo Exiles.exe aarch64 sha256sum
sha256sum build/win-aarch64/Exiles.exe

dumpbin //HEADERS build/win-aarch64/Exiles.exe
