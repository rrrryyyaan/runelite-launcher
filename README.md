...
- Replace all `Exiles` (case sensitive) with your server name.
- Replace all `exiles` (case sensitive) with your lowercase server name.
- Replace `exiles-ps.com`/`Exiles-ps.com` with your domain name.
