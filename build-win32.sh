...
cp native/build-x86/src/Release/Exiles.exe build/win-x86/
cp build/libs/Exiles.jar build/win-x86/
...
echo Exiles.exe 32bit sha256sum
sha256sum build/win-x86/Exiles.exe

dumpbin //HEADERS build/win-x86/Exiles.exe
